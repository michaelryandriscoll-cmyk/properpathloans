...
export default function SmsTermsPage() {
  return (
    <main style={{ padding: "120px 20px", maxWidth: "900px", margin: "0 auto", fontFamily: "inherit" }}>
      ...
      <p>SMS messaging is available on most major US carriers including AT&T, Verizon, T-Mobile, Sprint, and others. Carrier support may vary.</p>

      <h2>7. Privacy</h2>
      <p>Your phone number and personal information will not be shared with third parties for marketing purposes unrelated to your funding inquiry. For full details on how we handle your data, please review our <a href="/privacy-policy">Privacy Policy</a>.</p>

      <h2>8. Changes to These Terms</h2>
      <p>We reserve the right to modify these SMS Terms & Conditions at any time. Changes will be effective upon posting to this page.</p>
